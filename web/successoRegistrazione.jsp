<%-- 
    Document   : successoRegistrazione
    Created on : 3 giu 2022, 18:29:20
    Author     : erica
--%>
    ...
    <body>
        <div id="container">
            ...
            <div class="boxPresentazionePrincipale">
                <h2 id="titoloh2"> Ti sei registrato con successo! </h2>
                <div class="infoPagPrincipale">
                    
                    <a href="login.jsp"> Torna indietro per loggarti</a>
